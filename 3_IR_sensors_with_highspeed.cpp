...
//=====================================
  if(gtcbtrai == 1 && gtcbphai == 1 && gtcbgiua == 1){
    dithang();
  }
  else if (gtcbtrai == 0 && gtcbgiua == 1 && gtcbphai == 1){
    disangtrai();
  }
  else if (gtcbtrai == 0 && gtcbgiua == 0 && gtcbphai == 1){
    disangtrai();
  }
  else if (gtcbtrai == 1 && gtcbgiua == 1 && gtcbphai == 0){
    disangphai();
  }
  else if (gtcbtrai == 1 && gtcbgiua == 0 && gtcbphai == 0){
    disangphai();
  }
  else dunglai();
}
